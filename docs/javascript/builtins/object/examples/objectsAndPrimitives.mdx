...
```
>When creating a simple object Object.create({}) has no advantages over object literal notation. Other use cases of Object.create() is discussed later in [Prototype chain.](https://elkhan.me/2020/07/06/prototype-chain/%E2%80%8E(opens%20in%20a%20new%20tab))
---
...
```
---
>There are differences in creating objects using options above that will be further explored in [Prototype chain.](/prototype-chain/)
