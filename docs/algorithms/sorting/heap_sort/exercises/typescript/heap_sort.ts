...
/*
 ...
 // Get parent index
 const parentInd = Math.ceil(index / 2 - 1)
 ...
 Heap.prototype.removeMax = function removeMax() {
 ...
 const reheapify = function reheapify(index) {
