...
// to return the exponent value of the base.
...
// 5. Write a function 'recursiveMultiplier' that takes two arguments, 'arr and num', and multiplies
// each arr value into by num and returns an array of the values.
